...
class DA_Smoother2Horizon(DataAssimilationClass):
    ...
    # class. The ensemble is then propagated to the horizon in each
    # assimilation step. Also, the data array passed to the analysis
    # step is perturbed by samples from normal distribution controlled
    # by the data covariance matrix. For deterministic analysis
    # schemes and some particle filters this will not be necessary.
