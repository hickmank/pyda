...
from pyda.assimilation.assimilation_smoother2horizon import DA_Smoother2Horizon
...
class SIR_DA_SMOOTH2HORIZON(DA_Smoother2Horizon):
...
if __name__ == '__main__':
    ...
    DA_method = SIR_DA_SMOOTH2HORIZON(DataFileName,data_noise,data_lag,Horizon,EnSize,SimDim,ensemble_method,analysis_method)
